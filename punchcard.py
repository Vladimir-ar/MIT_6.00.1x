...
#url_commits = 'https://api.github.com/repos/%s/%s/commits' %(username, repo)
...
#    req_comm = urllib.request.Request(url_commits)
...
#    open_req_comm = urllib.request.urlopen(req_comm)
 ...
 #   data_comm_raw = (open_req_comm.read().decode('utf-8'))
    #except urllib.error.HTTPError:
     #   print ('Connection error. Next time try another username.')
     #   return
    #else:
    #    print(data_repo_raw)
    #    print (type (data_repo_raw))

  #  print(dara_comm_raw)
    #Get filtered list of repo names:
